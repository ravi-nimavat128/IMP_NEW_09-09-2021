        ...
        <ScrollView>
          <View
            ...
            <Text
              ...
              Due to heavy traffic we are unable to confirm your booking. Kindly
              check back with us in a new time slot.
            </Text>
            <Text
              style={{
                marginTop: 15,
              ...
              You can also call and check with us.
            </Text>
            {/*    <View
              style={{
                alignSelf: 'stretch',
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  <Image
                    source={require('../assets/image/calendar_dum.png')}
                    style={{
                      height: 40,
                      width: 40,
                      alignSelf: 'center',
