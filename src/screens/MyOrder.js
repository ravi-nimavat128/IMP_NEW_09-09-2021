...
class MyOrder extends Component {
  ...
  getPastOrderData = () => {
    ...
    axios
      .post(
        'http://binarygeckos.com/imp/apis/orders/user_pending_orders',
        formData,
      )
      .then(response => {
    ...
    return (
      <SafeAreaView
        ...
        <View style={style.header}>
          ...
          <Text style={style.txt_heading}>My Order</Text>
        </View>
        ...
        {this.state.PastOrderData == 0 ? (
          <View
            ...
            <Text
              ...
              All of My order will be shown here.
            </Text>
          </View>
        ) : (
          <ScrollView
            ...
            <View
              style={{
                ...
                height:
                  this.state.PastOrderData.length > 5
                    ? '100%'
