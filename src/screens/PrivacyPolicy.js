...
export default class PrivacyPolicy extends Component {
  ...
  FetchPrivecyPolicy = () => {
    ...
    axios
      .get('https://www.binarygeckos.com/imp/apis/general/privacy_policy')
      .then(response => {
        if (response.data.status == 1) {
          ...
          this.setState({
            ...
            privecy_data: response.data.data,
          });
        } else {
          console.log(response.data.status);
  ...
  render() {
    ...
    console.log(this.state.privecy_data);
    ...
    return (
      <SafeAreaView
        ...
        <View style={style.header}>
          ...
          <Text style={style.txt_heading}>Privacy Policy</Text>
        </View>
        ...
        <ScrollView style={{flex: 1}}>
          <HTMLView
            ...
            value={this.state.privecy_data}></HTMLView>
        </ScrollView>
      </SafeAreaView>
    );
  }
