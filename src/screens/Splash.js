  ...
  componentDidMount() {
    ...
    PushNotification.configure({
      ...
      onNotification: function (notification) {
        console.log('NOTIFICATION:', JSON.stringify(notification, 2, null));
        ...
        PushNotification.localNotification({
          ...
          messageId: notification.data.notification_id, // (optional) added as `message_id` to intent extras so opening push notification can find data stored by @react-native-firebase/messaging module.
  ...
  render() {
    return (
      <View
        ...
        <Image
          source={require('../assets/image/imp_logo.jpg')}
